...
Gdip_ImageSearch(pBitmapHaystack,pBitmapNeedle,ByRef FoundX1="",ByRef FoundY1="",ByRef OutputList=""
...
,SearchDirection=1,Instances=1,LineDelim="`n",CoordDelim=",") {
    ...
    ,Variation,SearchDirection,Instances,LineDelim,CoordDelim,FoundX1,FoundY1)
		; MsgBox % FoundX1
		; MsgBox % FoundY1
    Gdip_UnlockBits(pBitmapHaystack,hBitmapData)
...
,SearchDirection=1,Instances=0,LineDelim="`n",CoordDelim=",",ByRef FoundX1="",ByRef FoundY1="")
{
    OutputList := ""
